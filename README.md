...
- Browse the registry's content in a web browser: updating the registry generates a static HTML site listing every game grouped by system, with its name, description, and jaquette.
<!-- vibe:end:features -->
